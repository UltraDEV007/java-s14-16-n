...
VALUES
    ...
    (2, 'Pizza Margarita', 2, 'https://i.postimg.cc/j58qsk74/Pizza-Margarita.jpg', 'Mozzarella, Tomate, Albahaca, Masa de pizza', NULL, 7000.00, 15, 2),
    (3, 'Ensalada de atún', 3, 'https://i.postimg.cc/PJ9tDpKL/Ensalada-At-n.jpg', 'Lechuga, Atún, Huevo duro, Tomate, Aceitunas, Cebolla, Vinagreta', NULL, 2000.00, 10, 2),
    (4, 'Pizza Hawaiana', 2, 'https://i.postimg.cc/gcSrdryb/Pizza-Hawaiana.jpg', 'Jamón, Piña, Mozzarella, Masa de pizza', NULL, 8000.00, 15, 1),
    (5, 'Pizza Pepperoni', 2, 'https://i.postimg.cc/6qmQh16p/Pizza-Pepperoni.jpg', 'Pepperoni, Mozzarella, Masa de pizza, Salsa de tomate', NULL, 7500.00, 15, 1),
    (6, 'Pizza Vegetariana', 2, 'https://i.postimg.cc/HL9sNLWK/Pizza-Vegetariana.png', 'Pimientos, Cebolla, Champiñones, Tomate, Mozzarella, Masa de pizza', NULL, 9000.00, 15, 1),
    (7, 'Pollo al curry', 5, 'https://i.postimg.cc/zX4BbMPd/Pollo-Curry.jpg', 'Pollo, Curry, Leche de coco, Pimiento, Cebolla, Arroz', NULL, 7000.00, 30, 3),
